...
%% Pieces shape
PiecesShape_WholeYear;

%% Frame shape
FrameDefault = false(7,7);
FrameDefault(1:2,7)=true(2,1);FrameDefault(7,1:2)=true(1,2);FrameDefault(7,6:7)=true(1,2);

%% Qusetion
Month = 10;
Day = 6;
FrameQuestion = wholeYearPuzzle(Month,Day);
...
%% Plotting
ColorMaps = [1 1 1; 0 0.4 0.8; 0.4 0 0.8; 1 0.6 0.2; 1 1 0; 1 0 0; 0.2 0.6 1; 0.57 0.8 0.31; 0 0.69 0.31; 0.7 0.7 0.7];
NRow = 4;
NColumn = 7;
NImage = NRow*NColumn;
...
function [frame_question] = wholeYearPuzzle(Month,Day)
    ...
    if Day<29
        ...
        remDay = rem(Day,7);
        frame_question(7,remDay+2) = true;
    end
end