...
Month = 6;
Day = 4;
FrameQuestion = dailyPuzzle_v5(Month,Day);
...
%% Plotting
ColorMaps = [1 1 1; 0 0.4 0.8; 0.4 0 0.8; 1 0.6 0.2; 1 1 0; 1 0 0; 0.2 0.6 1; 0.57 0.8 0.31; 0 0.69 0.31; 1 0.55 0.56; 0.65 0.65 0.65];
NRow = 5;
NColumn = 9;
NImage = NRow*NColumn;
...
for p=1:NPage
    ...
    titlename = ['Solution of ', date2String(Month,Day), ' (Page', num2str(p,'%04d'), ')'];
    title(H0, titlename);
    set(gcf,'Position',[120 80 1540 880]);
    %H0.Visible = 'off';
    orient(gcf,'landscape')
    PrintFileName{p,1} = ['output/Solution_', date2String(Month,Day), '_P', num2str(p,'%04d'), '.pdf'];
...
function [frame_question] = dailyPuzzle_v5(Month,Day)
