...
%% Pieces shape
PiecesShape_DailyPuzzle_withWeekDay_v3;
...
FrameQuestion = dailyPuzzle_withWeekDay_v3(Month,Day,Week);
...
function [frame_question] = dailyPuzzle_withWeekDay_v3(Month,Day,Week)
    frame_question = false(5,10);
    if Month<=3
        frame_question(3,Month+7) = true;
    elseif Month<=7
        frame_question(4,Month-3+6) = true;
    else
        frame_question(5,Month-7+5) = true;
    end

    if Day<=6
        frame_question(1,Day+4) = true;
    elseif Day<=13
        frame_question(2,Day-6+3) = true;
    elseif Day<=20
        frame_question(3,Day-13) = true;
    elseif Day<=26
        frame_question(4,Day-20) = true;
    else
        frame_question(5,Day-26) = true;
    end
    
    if Week<=4
        frame_question(1,Week) = true;
    else
        frame_question(2,Week-4) = true;
    end
end