...
%% Pieces shape
PiecesShape_DailyPuzzle_withWeekDay_v2;

%% Frame shape
FrameDefault = false(9,6);
...
FrameQuestion = dailyPuzzle_withWeekDay_v2(Month,Day,Week);
                        ...
                        for L7=1:LN
                            ...
                            for L8=1:LN
                                ...
                                for L9=1:LN
                                    ...
                                    Frame9 = newFrame8;
                                    [isfit9, newFrame9] = isFit(Frame9, ExpandedPuzzlePieces{9,L9}, []);
                                    if isfit9
                                    Ouptput9 = Ouptput8;
                                    Ouptput9(9) = L9;
                                    write(filename,Ouptput9);
                                    end
                                    end
                                end
                                end
...
%% Plotting
ColorMaps = [1 1 1; 0 0.4 0.8; 0.4 0 0.8; 1 0.6 0.2; 1 1 0; 1 0 0; 0.2 0.6 1; 0.57 0.8 0.31; 0 0.69 0.31; 1 0.55 0.56];
NRow = 3;
NColumn = 8;
NImage = NRow*NColumn;
...
for p=1:NPage
    ...
    title(H0, titlename);
    set(gcf,'Position',[80 80 1600 880]);
    %H0.Visible = 'off';
...
function [frame_question] = dailyPuzzle_withWeekDay_v2(Month,Day,Week)
    frame_question = false(9,6);
    ...
    frame_question(ceil(Day/6)+2,remDay) = true;
    switch Week
        case 1
            frame_question(8,4) = true;
        case 2
            frame_question(8,5) = true;
        case 3
            frame_question(8,6) = true;
        case 4
            frame_question(9,3) = true;
        case 5
            frame_question(9,4) = true;
        case 6
            frame_question(9,5) = true;
        case 7
            frame_question(9,6) = true;
    end
end
